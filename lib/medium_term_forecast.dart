...
class MediumTermForecast extends StatefulWidget {
  @override
  _MediumTermForecastState createState() => _MediumTermForecastState();
}

class _MediumTermForecastState extends State<MediumTermForecast> {
  ...
  void submit() async {
    ...
    showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            title: Text('Load demand on this day'),
            content: Text(
              '$prediction MW',
...
//      backgroundColor: Colors.white,
      appBar: AppBar(
        title: Text(
          'Predict Medium Term Load Demand',
...
//                  return value;
                ...
                Text('Provide Pressure Value ( hPa )',
                    style: TextStyle(
                      color: Colors.white,
                    )),
                SizedBox(
                ...
                TextFormField(
                  ...
                  validator: (String value) {
                    if (value.isEmpty) {
                      return 'The pressure field is required';
                    }
                  },
                  style: TextStyle(color: Colors.white),
                  decoration: InputDecoration(
